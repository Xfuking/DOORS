...
local Window = OrionLib:MakeWindow({IntroText = "Fu Kang Hub",Name = "Fu Kang Hub ", HidePremium = false, SaveConfig = true, ConfigFolder = "Fu Kang Hub SaveConfig"})
if game.PlaceId == 6516141723 then
    OrionLib:MakeNotification({
        Name = "รัน Script เเล้ว",
        Content = "ขอให้สนุกกับการใช้ Script",
        Time = 5
    })
end
...
CreditsTab:AddParagraph("Credits to","ภาษิตยิงเบอร์ Siuu")
